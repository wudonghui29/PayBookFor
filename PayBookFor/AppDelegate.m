...
#define kVdiskSDKDemoAppKey             @"3623747849"
#define kVdiskSDKDemoAppSecret          @"95d37bda3fb9ef2acff104870bd2355c"
#define kVdiskSDKDemoAppRedirectURI     @"http://vauth.appsina.com"

#define kWeiboAppKey                    @"833125790"
#define kWeiboAppSecret                 @"9858157ace7449fe6a928a02ffcb5d2c"
#define kWeiboAppRedirectURI            @"http://www.sharesdk.cn"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    SinaWeibo *sinaWeibo = [[SinaWeibo alloc] initWithAppKey:kWeiboAppKey appSecret:kWeiboAppSecret appRedirectURI:kWeiboAppRedirectURI andDelegate:vc] ;
    VdiskSession *session = [[VdiskSession alloc] initWithAppKey:kVdiskSDKDemoAppKey appSecret:kVdiskSDKDemoAppSecret appRoot:@"b" sinaWeibo:sinaWeibo];
...
- (UINavigationController *)catalogNavigationController {
    ...
    if (!_catalogNavigationController) {
        ...
        myViewController *catalogViewController = [[myViewController alloc] init];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.xinyuan.PayBookFor" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"PayBookFor" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"PayBookFor.sqlite"];
    NSError *error = nil;
